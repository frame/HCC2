#if !defined(AFX_MSFLEXGRID_H__643D2AB9_7C0D_4795_848F_D9F2376D058A__INCLUDED_)
#define AFX_MSFLEXGRID_H__643D2AB9_7C0D_4795_848F_D9F2376D058A__INCLUDED_
...
#define GRID_BONUS		 3
#define GRID_BONUS		 3
#define GRID_REQUIREMENT 4
#define GRID_RESOURCE	 5
#define GRID_COMPONENT	 6
#define GRID_TECH			 7
#define GRID_TECHLIST	 8
#define GRID_MINORTITLE		 9
#define GRID_DESCRIPTION		 10
#define GRID_EFFECT		 11
#define GRID_EFFECTTITLE		 12
#define GRID_EFFECTDESCRIPTION		 13

#define GRID_TECHAVAIL	  18
#define GRID_TECHNOTAVAIL 19

#define GRID_TIERAVAIL	  20
#define GRID_TIERNOTAVAIL 21
#define GRID_SKILL 22

#define GRID_REPORTTITLE  30
#define GRID_REPORT1		  31
#define GRID_REPORT2		  32
#define GRID_BLANK		  33
#define GRID_SUBRESOURCE	 34
...
public:
	AddTitleRow(CString a_csMsg, int a_iStyle, CEdit *a_cSizingBox);
	AddRow(CString a_csMsg, int a_iStyle, CEdit *a_cSizingBox);
	AddRow(CString a_csMsg, int a_iStyle, int a_iRows = 1);
...
// Attributes
public:
	int m_pixelsperinchx;
	int m_pixelsperinchy;

// Operations
public:
	int GetGridMinHeight (int a_iMinRows, int a_iMaxRows, int a_iDefaultRows);
	DeterminePixelsPerInch();
	CRect GetCellRect (int a_iRow, int a_iCol);
	bool IsRowEnabled (int a_iRow);
	int FindRow (CString &a_csRowName, int a_iCol = 0);
	SelectRow (int a_iRow, bool IgnoreFirst = false);
	long GetRows();
...
#endif // !defined(AFX_MSFLEXGRID_H__643D2AB9_7C0D_4795_848F_D9F2376D058A__INCLUDED_)
